...
describe('ContentTransitionWrapper Component', () => {
  it.todo(
    ...
    // Note:
    // Create a wrapper component that will facilitate:
    // Condition: “Pill” component is used as tabs navigation
    // - Fade out/in animation for showing different contents (children)
